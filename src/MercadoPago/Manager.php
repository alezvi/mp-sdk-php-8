...
class Manager
{
     ...
     */
    protected function _getEntityConfiguration($entity): mixed
    {
     ...
     * @return void
     */
    protected function _updateEntityConfiguration($entity, $new_configuration): void
    {
        $className = $this->_getEntityClassName($entity);
     ...
     * @return void
     */
    public function addCustomTrackingParam($key, $value): void
    {
     ...
     * @throws Exception
     */
    public function execute($entity, $method = 'get', $options = []): mixed
    {
     ...
     * @return void
     */
    public function processOptions($options, $configuration): void
    {
     ...
     * @throws Exception
     */
    public function validateAttribute($entity, $attribute, array $properties, $value = null): void
    {
        $configuration = $this->_getEntityConfiguration($entity);
     ...
     * @return bool
     */
    protected function _isValidProperty($key, $property, $entity, $attribute, $value): bool
    {
        switch ($property) {
            case 'required':
     ...
     * @throws Exception
     */
    public function setEntityUrl($entity, $ormMethod, $params = []): void
    {
        $className = $this->_getEntityClassName($entity);
     ...
     * @return mixed
     */
    public function setEntityMetadata($entity): mixed
    {
     ...
     * @return string
     */
    protected function _getEntityClassName($entity): string
    {
        if (is_object($entity)) {
     ...
     * @return array
     */
    public function getExcludedAttributes($entity): array
    {
        $className = $this->_getEntityClassName($entity);
        $configuration = $this->_getEntityConfiguration($entity);
     ...
     * @param $entity
     */
    public function setEntityQueryJsonData($entity): void
    {
        $className = $this->_getEntityClassName($entity);
        $result = [];
    ...
    public function setRawQueryJsonData($entity, $data): void
    {
        $className = $this->_getEntityClassName($entity);
     ...
     * @param $entity
     */
    public function cleanEntityDeltaQueryJsonData($entity): void
    {
        $className = $this->_getEntityClassName($entity);
     ...
     * @param $entity
     */
    public function setEntityDeltaQueryJsonData($entity): void
    {
        $className = $this->_getEntityClassName($entity);
        $result = [];
     ...
     * @param $entity
     */
    public function cleanQueryParams($entity): void
    {
        $configuration = $this->_getEntityConfiguration($entity);
     ...
     */
    public function setQueryParams($entity, $urlParams = []): void
    {
        $configuration = $this->_getEntityConfiguration($entity);
     ...
     * @param $result
     */
    protected function _attributesToJson($entity, &$result): void
    {
        if (is_array($entity)) {
    ...
    protected function _arrayDiffRecursive($firstArray, $secondArray): array
    {
        $difference = [];
     ...
     * @param $configuration
     */
    protected function _deltaToJson($entity, &$result): void
    {
     ...
     * @return mixed
     */
    public function getPropertyType($entity, $property): mixed
    {
     ...
     * @return bool
     */
    public function getDynamicAttributeDenied($entity): bool
    {
        $metaData = $this->_getEntityConfiguration($entity);
     ...
     * @param $query
     */
    protected function _setCustomHeaders(&$entity, &$query): void
    {
     ...
     * @param $query
     */
    protected function _setDefaultHeaders(&$query): void
    {
     ...
     * @param string $method
     */
    protected function _setIdempotencyHeader(&$query, $configuration, $method): void
    {
     ...
     * @return string
     */
    protected function _getIdempotencyAttributes($attributes): string
    {
        $result = [];
        foreach ($attributes as $key => $value) {
