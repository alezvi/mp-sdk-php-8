...
class RestClient
{
     ...
     */
    protected ?Http\CurlRequest $httpRequest = null;
    ...
    /**
     * @param HttpRequest $connect
     * @param $customHeaders
     */
    protected function setHeaders(Http\HttpRequest $connect, $customHeaders): void
    {
     ...
     * @throws Exception
     */
    protected function setData(Http\HttpRequest $connect, $data, $content_type = ''): void
    {
     ...
     */
    public function getHttpRequest(): ?Http\CurlRequest
    {
     ...
     * @throws Exception
     */
    protected function exec($options): array
    {  
        $method = key($options);
        $requestPath = reset($options);
        $verb = self::$verbs[$method];
     ...
     * @param $value
     */
    public function setHttpParam($param, $value): void
    {
     ...
     * @return bool
     */
    protected function getArrayValue($array, $key): bool
    {
